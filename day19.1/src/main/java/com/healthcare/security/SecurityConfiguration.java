...
public class SecurityConfiguration {
	...
	SecurityFilterChain customizeSecFilterChain(HttpSecurity http) throws Exception 
	{
		...
		//2. Disable HttpSession - Tell Spring security - DO NOT create Http Session object to store security context
		...
		request.requestMatchers("/swagger-ui/**","/v3/api-docs/**","/users/signin"
				,"/patients/signup").permitAll()
		...
		.requestMatchers("/appointments/doctor/mark_complete")
		.hasRole("DOCTOR")
